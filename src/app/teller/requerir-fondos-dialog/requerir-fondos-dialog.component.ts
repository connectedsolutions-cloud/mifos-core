...
const BLUEPRINT_NAME = 'requerir-fondos-caja-boveda';
...
export interface RequerirFondosDialogData {
  cashierId: number;
  currencyCode: string;
}

@Component({
  selector: 'mifosx-requerir-fondos-dialog',
  templateUrl: './requerir-fondos-dialog.component.html',
  styleUrls: ['./requerir-fondos-dialog.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class RequerirFondosDialogComponent implements OnInit {
  form: FormGroup;
  users: any[] = [];
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: RequerirFondosDialogData,
    private dialogRef: MatDialogRef<RequerirFondosDialogComponent>,
