...
export class WebAppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    // Check for version changes and clear localStorage if needed
    // This must be done FIRST, before any other code reads from localStorage
    const storageCleared = this.versionCheckService.checkAndClearStorage(false);
    if (storageCleared) {
      log.info('Application version changed - localStorage cleared');
      // Optionally show a notification to the user
      // You can uncomment this if you want to notify users about the cache clear
      // this.alertService.alert({
      //   type: 'info',
      //   message: 'Application updated. Your preferences have been reset.'
      // });
    }
